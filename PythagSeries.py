...
class PythagSeries(Scale):
    ...
    def get_spacing(self, interval_number_left, interval_number_right):
        ...
        numerator = sorted_scale[interval_number_right - 1].new_numerator * sorted_scale[
            interval_number_left - 1].new_denom
        denominator = sorted_scale[interval_number_right - 1].new_denom * sorted_scale[
            interval_number_left - 1].new_numerator
